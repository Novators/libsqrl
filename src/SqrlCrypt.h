...
public:
	...
	static void sign( const std::string *msg, const uint8_t sk[32], const uint8_t pk[32], uint8_t sig[64] );
	static bool verifySignature( const std::string *msg, const uint8_t *sig, const uint8_t *pub );
